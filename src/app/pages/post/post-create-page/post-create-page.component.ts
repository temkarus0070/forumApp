...
export class PostCreatePageComponent implements OnInit {
  ...
  constructor(private sectionService:SectionService,private router:Router,private postService:PostService,private routerHander:ActivatedRoute) {
    this.routerHander.data.subscribe(e=>{
      this.availableSections=e.sections;
    });
  }
